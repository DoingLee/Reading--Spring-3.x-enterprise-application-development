...
public class JdbcUserService {
    ...
    public static void main(String[] args) {
        ...
        TransactionAwareDataSourceProxy b = (TransactionAwareDataSourceProxy) ctx.getBean("dataSource");
        BasicDataSource basicDataSource = (BasicDataSource)b.getTargetDataSource();
